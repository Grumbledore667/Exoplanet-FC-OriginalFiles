...
function CEnergySphere:OnCreate()
   ...
   self.electroHitSound = self:createAspect("Play_energy_bubble_discharge")
   ...
   self.soundDestroyed = self:createAspect("Play_energy_bubble_destroyed")
   self.soundDestroyed:getPose():setParent(self:getPose())
   self.soundDestroyed:getPose():resetLocalPose()

   self.soundBuzz = self:createAspect("Play_energy_bubble_buzz")
