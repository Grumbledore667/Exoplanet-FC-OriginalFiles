...
spwn_tutorial_upper_camp_arch_sniper_3 =
   ...
   abori_sh_indoors_gatekeeper =
   {
      active = true,
      spawnDist = 7500,
      lootItems = { ["22_ammo.itm"] = 15,
         ["blood_root.itm"] = 2,
         ["capsule_health.itm"] = 3,},
      weapons = { "scamp_22.gun", },
      styles = { "scalphunter_indoors_gatekeeper", },
      characterType = "abori.cfg",
      characterClass = "CBandit",
      spawnCountMax = 1,
      aliveCountMax = 1,
      zoneSize = 200,
      customLabel = "Scalphunter gatekeeper",
   },

abori_sh_indoors_sniper_2 =
   {
      active = true,
      spawnDist = 7500,
      lootItems = { ["revolver_ammo.itm"] = 4,
         ["slime_meat.itm"] = 2,
         ["firewood.itm"] = 1,},
      weapons = { "carbine.gun", },
      styles = { "scalphunter_indoors_sniper_2", },
      characterType = "abori.cfg",
      characterClass = "CBandit",
      spawnCountMax = 1,
      aliveCountMax = 1,
...
abori_sh_indoors_sniper_1 =
   {
      ...
      lootItems = { ["revolver_ammo.itm"] = 6,
         ...
         ["joint.itm"] = 1,},
      weapons = { "carbine.gun", },
      styles = { "scalphunter_indoors_sniper_1", },
      characterType = "abori.cfg",
      characterClass = "CBandit",
      spawnCountMax = 1,
      aliveCountMax = 1,
