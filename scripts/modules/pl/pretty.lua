...
--
-- Dependencies: `pl.utils`, `pl.lexer`, `pl.stringx`, `pl.tablex`, `debug`
-- @module pl.pretty
...
---	Create a string representation of a Lua table. (Modified with tablex.sort)
...
function pretty.writeSorted(tbl,space,not_clever)
   ...
   writeit = function (t,oldindent,indent)
      ...
      elseif tp == 'table' then
         ...
         for key,val in tablex.sort(t) do
            local tkey = type(key)
