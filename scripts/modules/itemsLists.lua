...
itemsLists.tradeLists =
{
   ...
   ["zaba_the_sweet_talker_trade_inventory"] = {
      ["antigravium_shards.itm"]        = 900,
      ["joint.itm"]                     = 25,
      ["bluethorn_leaf.itm"]            = 50,
      ["sweet_joy.itm"]                 = 5,
   },
   ...
   ["stone_heads_trader_trade_inventory"] = {
      ...
      ["good_pickaxe.tmpl"]               = 1,
      ["worker_pants.itm"]                = 1,
      ["electrical_tape.itm"]                   = 4,
   },
}

itemsLists.modelsList =
{
   ["bottle_booze.sbg"]          = "booze.itm",
