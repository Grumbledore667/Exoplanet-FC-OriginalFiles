...
\
";
		["text"] = "ask about workers";
		["time"] = 1;
		["topic"] = "helping_hands:workers";
		["type"] = "message";
	};
	["message_00003"] = {
		["ID"] = 3;
...
";
	...
	["message_00032"] = {
		...
		["posY"] = 660;
		["script"] = "";
		["text"] = "Get those that weren't injured near the containers in which they live in the Fort. Tell them I ordered them to work for Eli for the time being.";
		["time"] = 15;
		["topic"] = "helping_hands:workers";
		["type"] = "message";
	};
