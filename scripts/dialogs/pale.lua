...
function message:onStart()\
   self:setParam(\"random\", random.random(6))\
end\
\
function message:onStop()\
end\
...
";
	...
	["message_00010"] = {
		...
		["posY"] = 360;
		["script"] = "";
		["text"] = "Ha-ha-ha! What a toy knows about the master's will, the way they design things to function? But who am I to blame you? Just another puppet. A pile of useless thoughts and memories. A shadow that disappears when the sun comes out.";
		["time"] = 22;
		["type"] = "message";
	};
	["message_00011"] = {
