...
";
	...
	["message_00096"] = {
		...
		["posY"] = 390;
		["script"] = "";
		["text"] = "My special is just regular booze, absinthe and a special ingredient - a bit of Arphant's poop. Just don't tell anyone.";
		["time"] = 11.5;
		["topic"] = "recipes:learn_recipe_kwagga_special_1";
		["type"] = "message";
	};
	["message_00097"] = {
		["ID"] = 97;
	...
	["message_00099"] = {
		...
		["posY"] = 390;
		["script"] = "";
		["text"] = "Yeah, I get it now. Thanks...";
		["time"] = 4;
		["topic"] = "scarecrow:kwagga_about_special_booze";
		["type"] = "message";
	};
	["switch_00001"] = {
		["ID"] = 1;
