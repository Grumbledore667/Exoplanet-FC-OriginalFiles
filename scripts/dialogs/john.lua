...
\
";
		["text"] = "Can't let you in though, we have enough people on welfare.";
		["time"] = 6.5;
...
";
	...
	["message_00014"] = {
		...
		["posY"] = 330;
		["script"] = "";
		["text"] = "But a donation of 1000 antigravium to the fort's budget will grant you free passage no matter your outfit.";
		["time"] = 10.5;
...
\
";
		["text"] = "\\[Give 1000 antigravium]Yeah, sure.";
		["time"] = 3;
