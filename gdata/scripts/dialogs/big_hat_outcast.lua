...
";
	...
	["message_00102"] = {
		...
		["posY"] = -330;
		["script"] = "";
		["text"] = "[t_to_fort:start]Go down to the lake, then turn west. Make your way through the mountain path called Cutthroat Passage. Find the caravan trail leading north, away from the desert, then proceed, following the big river.";
		["time"] = 18;
		["type"] = "message";
	};
	["message_00103"] = {
...
\
";
		["text"] = "[t_my_clothes:big_hat_looters]A bunch of aborigines robbed me when I was unconcious.";
		["time"] = 6;
		["type"] = "message";
	};
	["message_00115"] = {
