...
";
	...
	["message_00039"] = {
		...
		["posY"] = 780;
		["script"] = "";
		["text"] = "I don't thik we can afford another mouth to feed. Maybe later...";
		["time"] = 7;
		["type"] = "message";
	};
	["message_00093"] = {
	...
	["message_00102"] = {
		...
		["posY"] = -270;
		["script"] = "";
		["text"] = "[t_to_fort:start]Go down to the lake, then turn west. Make your way trough the mountain path called Cutthroat Passage. Find the caravan trail leading north, away from the desert, then proceed, following the big river.";
		["time"] = 18;
		["type"] = "message";
	};
	["message_00103"] = {
...
";
	...
	["message_00129"] = {
		...
		["posY"] = 540;
		["script"] = "";
		["text"] = "Don't think you want to know all the details... First the taboo bubles stopped appearing regularly. We cannot scavenge good stuff for sale now.";
		["time"] = 13;
		["type"] = "message";
	};
	["message_00130"] = {
	...
	["message_00147"] = {
		...
		["posY"] = 540;
		["script"] = "";
		["text"] = "We even made a hunting party of young ones. Pretty succesefull for our standards, got meat in every pot almost every day. But then things went south...";
		["time"] = 14.5;
		["type"] = "message";
	};
	["message_00148"] = {
		...
		["posY"] = 540;
		["script"] = "";
		["text"] = "Then a mad human has settled in the container carrier's wreck and boobie-traped the surroundings. Can't loot there either now. Then a pack of scalp hunters appeared and cut down our hunting party.";
		["time"] = 17;
		["type"] = "message";
	};
	["message_00149"] = {
...
\
function message:isVisible()\
   return getQuestTopicVisible(\"angry_bugs\", \"big_hat_reward\") and self:isFirstTime()\
end\
\
";
...
\
";
		["text"] = "[t_angry_bugs:big_hat_reward]Let me thank you for it with this.";
		["time"] = 5;
		["type"] = "message";
	};
	["message_00159"] = {
		...
		["posY"] = 210;
		["script"] = "";
		["text"] = "Thanks, do you maybe have some spare ammo for me?";
		["time"] = 6;
		["type"] = "message";
	};
	["message_00161"] = {
		...
		["posY"] = 90;
		["script"] = "function message:onStart()\
   addItemsToPlayer(\"flare_ammo.itm\", 5)\
end\
\
function message:onStop()\
end\
...
";
	...
	["message_00162"] = {
		...
		["posY"] = 210;
		["script"] = "function message:onStart()\
   addItemsToPlayer(\"22_ammo.itm\", 10)\
end\
\
function message:onStop()\
end\
...
";
	...
	["message_00163"] = {
		...
		["posY"] = 330;
		["script"] = "function message:onStart()\
   addItemsToPlayer(\"revolver_ammo.itm\", 10)\
end\
\
function message:onStop()\
end\
