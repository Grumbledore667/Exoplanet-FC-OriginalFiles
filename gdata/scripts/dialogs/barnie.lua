...
\
";
		["text"] = "[t_to_fort:guards_bad_attire]Trying to enter the fort? No pass will be granted to strange drifters!";
		["time"] = 7.5;
		["type"] = "message";
	};
	["message_00006"] = {
...
";
	...
	["message_00011"] = {
		...
		["posY"] = 360;
		["script"] = "";
		["text"] = "[t_to_fort:finish]A stranger, but a respectable one. Welcome.";
		["time"] = 1.5;
		["type"] = "message";
	};
	["message_00012"] = {
