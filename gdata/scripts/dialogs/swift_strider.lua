...
";
	...
	["message_00084"] = {
		...
		["posY"] = -210;
		["script"] = "";
		["text"] = "Have any water left? My throat is parched.";
		["time"] = 5;
		["type"] = "message";
	};
	["message_00085"] = {
...
\
";
		["text"] = "[HIDDEN]The last raider I saw leaving was carrying my hatchet in his back. He couldn't have gotten far. If you give it to my brother Carry-the-Stone in the town, he should reward you.";
		["time"] = 17.5;
		["type"] = "message";
	};
	["message_00165"] = {
		...
		["posY"] = 2280;
		["script"] = "function message:onStart()\
   if not isQuestActive(\"family_relic\") then\
      getQuest(\"family_relic\"):start()\
   end\
end\
\
function message:onStop()\
...
\
function message:isVisible()\
   if getQuestActiveStepName(\"family_relic\") == \"give_to_bro\" then\
      return false\
   end\
   return true\
end\
...
\
function message:isVisible()\
   if(not self:getDialogParam(\"n188\")) then\
      return true\
   end\
   return false\
end\
...
\
function message:isVisible()\
   return getQuestTopicVisible(\"family_relic\", \"strider_give_axe\")\
end\
\
";
		["text"] = "Is that your hatchet?";
	...
	["message_00212"] = {
		...
		["posY"] = 1380;
		["script"] = "";
		["text"] = "[t_family_relic:strider_give_axe]Looks like it. Thank you huma. Now I can die peacefully.";
		["time"] = 6.5;
		["type"] = "message";
	};
	["message_00214"] = {
...
";
	...
	["message_00239"] = {
		...
		["posY"] = -1080;
		["script"] = "";
		["text"] = "The last raider I saw leaving was carrying my hatchet in his back. He couldn't have gotten far.";
		["time"] = 10;
		["type"] = "message";
	};
	["message_00240"] = {
		...
		["posY"] = -1080;
		["script"] = "";
		["text"] = "It's a family relic. I'd like to die holding it in my hands.";
		["time"] = 7.5;
		["type"] = "message";
	};
	["message_00241"] = {
		...
		["posY"] = -1140;
		["script"] = "";
		["text"] = "[t_family_relic:start]And where should I start looking?";
		["time"] = 4;
		["type"] = "message";
	};
	["message_00242"] = {
		...
		["posY"] = -1140;
		["script"] = "";
		["text"] = "Just follow the bloody trail.";
		["time"] = 3.5;
		["type"] = "message";
	};
	["message_00243"] = {
		...
		["posY"] = -1020;
		["script"] = "";
		["text"] = "It's a family relic for me and my brother. Otherwise it's just a rusty piece of junk, that isn't even worth the iron it's made of. What's an old dull axe to you, huma?";
		["time"] = 18;
		["type"] = "message";
	};
	["message_00245"] = {
...
\
";
		["text"] = "[t_family_relic:strider_give_axe]Is that your hatchet?";
		["time"] = 3;
		["type"] = "message";
	};
	["message_00253"] = {
...
";
   ...
   giveItemToNPC(booze, \"swift_strider\")\
end\
\
function message:onStop()\
end\
...
\
";
		["text"] = "[t_family_relic:strider_give_axe_safe]Looks like it. Thank you huma... For everything.";
		["time"] = 6.5;
		["type"] = "message";
	};
	["message_00291"] = {
	...
	["message_00293"] = {
		...
		["posY"] = -1230;
		["script"] = "";
		["text"] = "Looks like it... Thank you huma. Now I can die peacefully.";
		["time"] = 6.5;
		["type"] = "message";
	};
	["message_00294"] = {
