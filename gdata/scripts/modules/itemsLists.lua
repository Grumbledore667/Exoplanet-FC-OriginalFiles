...
local function getModelForItem(itemName)
   local model = ItemsData.ItemsInfo[itemName].model or getKeyByValue( itemsLists.modelsList, itemName )
   return model
end
...
itemsLists.getModelForItem = getModelForItem
