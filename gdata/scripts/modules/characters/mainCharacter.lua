...
local CMainCharacter = oo.class({ inventoryType = "player" }, CPlayer)
...
function CMainCharacter:OnControlDown(code)
   ...
   elseif ((code == getButtonCode("INVENTORY") or code == getButtonCode("INVENTORYALT"))
      ...
      if gameplayUI.inventoryPlayer:isVisible() or gameplayUI.characterUI:isVisible() then
         gameplayUI.characterUI:show(false)
         gameplayUI.inventoryPlayer:show(false)
      else
         gameplayUI.characterUI:show(true)
   ...
   elseif code == getButtonCode("CHARACTER") and self:canUseUI() then
      gameplayUI.characterUI:show(not gameplayUI.characterUI:isVisible())
...
function CMainCharacter:addLevels(value, silent)
   if value > 0 then
      if self.level == 1 then
         gameplayUI.annoyingHintUI:addTask(function() return string.format("You've got attribute points! Press '%s' to raise your stats.", getButtonCurrentKeyName("CHARACTER")) end, "AP")
