...
function CItem:initSounds()
   ...
   --Default values
   soundsList.equip = soundsList.equip or {name = "common_item_equip.wav", distance = 2000}
   soundsList.unequip = soundsList.unequip or {name = "common_item_unequip.wav", distance = 2000}
...
function CItem:OnActivate()
   ...
   elseif self:isMap() then
      gameplayUI.mapUI:show(not gameplayUI.mapUI:isVisible(), self:getItemName())
