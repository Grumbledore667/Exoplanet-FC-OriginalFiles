   ...
   en = {
      loading_screen = {
         ...
         tips_keys = {
            ...
            needs = "Keep an eye on your hunger and thirst levels (${inventory} key). Your health and stamina regenerate faster when you aren't hungry, thirsty and are well-rested.",
            status_effects = "Food and drinks apply various effects on consumption. Hit ${inventory} key to see them.",
