local helpKeys = [===[[colour='ffffffff'][font='dialog-14']Controls:[font='dialog-12'][colour='ffaaaaaa']
      ...
      •   [colour='ffffffff']${inventory}[colour='ffaaaaaa'] – Inventory and character overview
