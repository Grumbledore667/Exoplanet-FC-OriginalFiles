...
function CBeacon:initPrefabs()
   ...
   self.sounds = {}
   self.sounds.Lamp_Open = self:initSound("beacon_lamp_open.wav")
   self.sounds.Lamp_Close = self:initSound("beacon_lamp_close.wav")
   self.sounds.Battaries_Open = self:initSound("beacon_battary_open.wav")
   self.sounds.Battaries_Close = self:initSound("beacon_battary_close.wav")
end
