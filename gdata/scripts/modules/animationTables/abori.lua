local animations = {
   idle = {
      ...
      eat = {
         left_handed = "dl_chintouch_start",
      },
   },
   walk = {
      front = {
...
assignEvent "idle_smoking"            "smoking_draw" {56} "smoking_blow" {90} "smoke" {90,137}
assignEvent "dl_chintouch_start"      "spawn_item"   {0}  "buff_apply"   {30}
assignEvent "idle_drink"              "drink_start"  {0}  "buff_apply"   {30} "item_change" {90}
