...
assignEvent "drink_short"                     "drink_sound"     {0}  "spawn_item"   {0}  "buff_apply"   {65}
assignEvent "eat_short"                       "eat_sound"       {0}  "spawn_item"   {0}  "buff_apply"   {15} "item_change" {44}
...
assignEvent "use__injector_idle"              "spawn_item"      {0}  "injector_sound" {16} "buff_apply" {20} "item_change" {20}
