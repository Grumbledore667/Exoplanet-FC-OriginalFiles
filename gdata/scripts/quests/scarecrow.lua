...
";
   ...
   getObj(\"red\"):setPatrolRoute(table.concat(self.red_drink_wp_group, \",\"))\
   return true\
end\
\
";
   ...
   getObj(\"red\"):setPatrolRoute(table.concat(self.red_back_wp_group, \",\"))\
   return true\
end\
\
";
...
\
   ...
   self:declareVar(\"chip_cut_animation\", \"idle_cutting_chip\")\
\
